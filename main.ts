...
let lsfx_player_hit = [music.createSoundEffect(WaveShape.Noise, 1627, 3232, 255, 255, 300, SoundExpressionEffect.Tremolo, InterpolationCurve.Linear), music.createSoundEffect(WaveShape.Noise, 1627, 3232, 255, 255, 300, SoundExpressionEffect.Tremolo, InterpolationCurve.Linear), music.createSoundEffect(WaveShape.Noise, 1627, 3232, 255, 255, 300, SoundExpressionEffect.Tremolo, InterpolationCurve.Linear)]
...
// sound for missile shot
let sfx_death = music.createSoundEffect(WaveShape.Square, 4299, 1137, 255, 50, 1000, SoundExpressionEffect.Warble, InterpolationCurve.Curve)
...
game.onUpdate(function () {
    ...
    if (playerWeapon == 1 && (weaponCooldown == 0 && controller.A.isPressed())) {
        weaponCooldown = 0.6
